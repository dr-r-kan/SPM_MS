...
% confirmed-correct raw-template orientation (raw geometry + 90 deg
% anticlockwise).
%
...
row_specs = { ...
    ...
    struct('label', 'Reference: raw +90 anticlockwise', 'maps', template_maps, 'chanlocs', reference_chanlocs)};
